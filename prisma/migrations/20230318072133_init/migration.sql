...
CREATE TABLE "Review" (
    ...
    "censoredReviewerUsername" TEXT NOT NULL,
    "listingId" TEXT,
...
-- CreateIndex
CREATE UNIQUE INDEX "Client_userId_username_key" ON "Client"("userId", "username");
...
-- CreateIndex
CREATE UNIQUE INDEX "Listing_id_providerId_key" ON "Listing"("id", "providerId");
...
-- AddForeignKey
ALTER TABLE "Client" ADD CONSTRAINT "Client_userId_username_fkey" FOREIGN KEY ("userId", "username") REFERENCES "User"("id", "username") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_providerId_providerUsername_fkey" FOREIGN KEY ("providerId", "providerUsername") REFERENCES "Provider"("userId", "username") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Review" ADD CONSTRAINT "Review_reviewerId_reviewerUsername_fkey" FOREIGN KEY ("reviewerId", "reviewerUsername") REFERENCES "Client"("userId", "username") ON DELETE CASCADE ON UPDATE CASCADE;
