...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly apps create experience-7b04
  fly apps create experience-7b04-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app experience-7b04
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app experience-7b04-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'experience-7b04-staging' does not match app name in config file 'experience-7b04'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name experience-7b04-db
  fly postgres attach --app experience-7b04 experience-7b04-db

  fly postgres create --name experience-7b04-staging-db
  fly postgres attach --app experience-7b04-staging experience-7b04-staging-db
  ```
